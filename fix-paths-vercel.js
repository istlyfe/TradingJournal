...
// Ensure critical directories exist - only use lowercase
...
// Force create the files directly - only lowercase versions
...
// Create a symlink to handle case-sensitivity issues
// This way imports with @/Components/... will resolve to @/components/...
if (process.platform === 'linux') {
  console.log('Creating case-insensitive symlinks for linux deployment');
  try {
    // If Components directory exists, remove it first
    if (fs.existsSync('Components')) {
      fs.rmdirSync('Components', { recursive: true });
    }
    
    // Create a symlink from Components to components
